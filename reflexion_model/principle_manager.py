...
class MemoryManager:
    ...
    def add_experience_batch(self, patterns: List[str], strategies: List[str], embeddings):
    ...
    def update_scores_batch(self, usage_data, is_correct_list, model_outputs):
        ...
        for used_rules, is_correct, output_txt in zip(usage_data, is_correct_list, model_outputs):
